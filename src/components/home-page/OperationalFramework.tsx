			...
			<div className="mx-auto max-w-6xl">
				<div className="mx-auto mb-16 max-w-4xl text-center">
					<SectionHeading size="large">
						...
						<span className="text-[#606bfa]">AI Automation</span> <br className="md:hidden" />{' '}
						Actually Works
					</SectionHeading>

					<p className={paragraphStyles}>
						Most agencies try to implement AI on top of broken operations, creating more chaos than
						clarity. We fix the operations first.
					</p>
				</div>
				...
				<div className="relative">
					<div className="mx-auto mb-16 max-w-4xl text-center">
						...
						<p className={paragraphStyles}>
							Our Operational Intelligence Framework focuses on building strong operational systems
							first, ensuring that AI automation delivers real impact rather than adding complexity.
						</p>
					</div>
					...
					{/* Mobile Fallback */}
					<div className="mt-12 space-y-8 px-4 md:hidden">
						{[
							{
							...
							<div key={i} className="border-l-2 border-[#606bfa] pl-4">
								...
								<p className="mt-1 text-sm text-white opacity-80">{item.d}</p>
							</div>
						))}
					</div>
				</div>
