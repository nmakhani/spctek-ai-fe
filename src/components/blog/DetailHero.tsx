...
export default function BlogDetailHero({ blog }: BlogDetailHeroProps) {
	...
	return (
		<div className="relative overflow-hidden px-4 pb-8 pt-28 md:px-6 md:pb-10 md:pt-36 lg:px-12">
			...
			<div className="relative mx-auto max-w-5xl rounded-3xl border border-white/15 bg-[linear-gradient(135deg,rgba(255,255,255,0.08)_0%,rgba(255,255,255,0.03)_40%,rgba(96,107,250,0.11)_100%)] p-6 shadow-[0_24px_50px_rgba(0,0,0,0.45)] backdrop-blur-xl md:p-10">
				<p className="text-xs uppercase tracking-[0.22em] text-[#aeb5ff]">SPCTEK Journal</p>
				<h1 className="mt-4 text-3xl font-semibold leading-tight text-white md:text-4xl lg:text-5xl">{blog.title}</h1>
				{blog.summary && (
					<p className="mt-5 max-w-3xl text-base leading-relaxed text-white/75 md:text-lg">{blog.summary}</p>
				)}
