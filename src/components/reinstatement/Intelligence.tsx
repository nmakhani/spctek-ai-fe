...
const intelligenceTypes: IntelligenceType[] = [
  ...
  },
  {
    ...
    description:
      "Built on real Amazon policies, suspension codes, and successful appeals data.",
  },
  {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto mb-16 max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-3xl font-light leading-relaxed text-white md:text-2xl">
            The Reinstatement Estimator analyzes your suspension using
            Amazon-specific data to deliver a clear viability score and the
            smartest path to reinstatement.
          </p>
        </div>

        {/* Business Types Grid */}
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 max-w-[900px] mx-auto mb-12">
