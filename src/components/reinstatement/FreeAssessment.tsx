...
const REINSTATEMENT_FIELDS: FieldConfig[] = [
  {
    ...
    placeholder:
      "Paste the full text of your Amazon Performance Notification email here...",
  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-5xl">
        <div className="mx-auto mb-10 max-w-4xl text-center md:mb-12">
          <SectionHeading size="large">
            Amazon <span className="text-[#606bfa]">Reinstatement</span>{" "}
            Estimator
          </SectionHeading>
          <p className="mx-auto mt-5 max-w-4xl text-lg leading-[1.35] text-white md:text-2xl">
            Paste your Amazon performance notification to get an instant
            AI-powered reinstatement assessment with clear next steps.
          </p>
        </div>
      ...
      {isModalOpen && (
        ...
        >
          <div className="w-full max-w-2xl max-h-[95vh] overflow-y-auto rounded-2xl bg-[#1a1a1a] p-6 md:p-10 border border-white/10 shadow-2xl custom-scrollbar">
            <div className="mb-6">
