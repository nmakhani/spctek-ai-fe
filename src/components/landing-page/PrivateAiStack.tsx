	...
	return (
		<section className="font-poppins relative px-4 md:px-6 lg:px-12">
			...
			<div className="mx-auto max-w-7xl">
				{/* Header Section */}
				<div className="mx-auto mb-10 max-w-4xl text-center md:mb-14 lg:mb-20">
					<SectionHeading size="large">
						Private <span className="text-[#606bfa]">AI Stack</span> Built for Your
						<br />
						Infrastructure
					</SectionHeading>
					<p className="mx-auto mt-5 max-w-3xl text-base font-light leading-relaxed text-white sm:text-lg md:mt-6 md:text-xl lg:mt-8 lg:text-xl">
				...
				{/* Stack Grid */}
				<div className="relative mb-8 mt-8 flex flex-col items-start justify-center gap-6 md:mb-10 md:mt-10 md:flex-row md:flex-wrap md:justify-center md:gap-x-10 md:gap-y-8 lg:mb-12 lg:mt-12 lg:flex-nowrap lg:gap-0">
					{stackComponents.map((item, index) => (
						<React.Fragment key={item.title}>
							<div className="flex w-full flex-col items-center md:w-[170px] lg:w-[170px]">
								{/* Icon Glass Card */}
								<div
									...
									style={{
										...
										boxShadow: '0 12px 22px rgba(3, 7, 22, 0.42), inset 0 1px 0 rgba(255,255,255,0.12)',
									}}
								>
								...
								<div className="px-1 text-center">
									...
									<p className="mx-auto max-w-[170px] text-sm font-light leading-snug text-white">{item.description}</p>
								</div>
							</div>

							{/* Arrow Spacer */}
							{index < stackComponents.length - 1 && (
								<div className="hidden h-24 w-6 items-center justify-center opacity-70 lg:flex">
									<svg
										width="32"
										height="32"
										viewBox="0 0 24 24"
				...
				{/* Sub-Bullets */}
				<div className="flex flex-col items-center justify-center gap-3 text-center md:gap-8 lg:flex-row lg:gap-24">
					<p className="text-[12px] font-normal tracking-wide text-white/30">No dependency on third-party AI APIs</p>
					{/* Optional: subtle dot separator for desktop */}
					{/* <div className="hidden md:block w-1 h-1 rounded-full bg-white/10" /> */}
					<p className="text-[12px] font-normal tracking-wide text-white/30">No external data transfer</p>
					{/* <div className="hidden md:block w-1 h-1 rounded-full bg-white/10" /> */}
					<p className="text-[12px] font-normal tracking-wide text-white/30">Secure access for internal teams only</p>
				</div>
