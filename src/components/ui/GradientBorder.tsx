export const GradientBorder = ({
	...
	const defaultGradient = hasError
		? 'linear-gradient(135deg, rgba(255,255,255,0.75) 0%, #9c1a1a 50%, rgba(255,255,255,0.75) 100%)'
		: 'linear-gradient(135deg, rgba(255,255,255,0.75) 0%, #606bfa 50%, rgba(255,255,255,0.75) 100%)';

	const subtleGradient = hasError
		? 'linear-gradient(135deg, rgba(255,255,255,0.75) 0%, rgba(248,113,113,0.4) 50%, rgba(255,255,255,0.75) 100%)'
